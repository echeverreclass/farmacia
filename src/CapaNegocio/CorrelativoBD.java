...
public class CorrelativoBD {
    ...
    public List<Correlativo> reportarCorrelativo(String tienda) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, e, "Problemas al reportar correlativo BD", JOptionPane.ERROR_MESSAGE);
            return null;
        }
        return lista;
    }
    ...
    public boolean registrarCorrelativo(Correlativo co) {
        boolean rpta = false;
        sql = "INSERT INTO correlativo(idcorrelativo,coSerie,coNumeracion,coDocumento,tienda) VALUES(NULL,?,?,?,?)";
        try {
            cn = mysql.conectar();
            PreparedStatement pst = cn.prepareStatement(sql);
            ...
            JOptionPane.showMessageDialog(null, e, "Problemas al registrar Correlativo", JOptionPane.ERROR_MESSAGE);
            return rpta;
        }
    }
    ...
    public boolean modificarCorrelativo(Correlativo co) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, e, "Problemas al modificar Correlativo", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
            return rpta;
        }
    }
    ...
    public boolean eliminarCorrelativo(int idcorrelativo) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, e, "Problemas al eliminar Correlativo", JOptionPane.ERROR_MESSAGE);
            return rpta;
        }
    }
    public List<Correlativo> sacarNumeracion(String documento,String tienda) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error en el correlativo");
            e.printStackTrace();
        }
        return lista;
    }
    public boolean actualizarCorrelativo(Correlativo co) {
        ...
        try {
            ...
            pst.setString(1, co.getCoNumeracion());
            pst.setString(2, co.getCoDocumento());
            pst.setString(3, co.getTienda());
            ...
            JOptionPane.showMessageDialog(null, e, "Problemas al actualizar Correlativo", JOptionPane.ERROR_MESSAGE);
            return rpta;
        }
    }
