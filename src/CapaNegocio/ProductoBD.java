...
public class ProductoBD {
    ...
    public DefaultTableModel reportarProducto() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, e, "Problemas al reportar Producto", JOptionPane.ERROR_MESSAGE);
            return null;
        }
    }
    ...
    public boolean eliminarProducto(String serie) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, e, "Problemas al eliminar producto", JOptionPane.ERROR_MESSAGE);
            return rpta;
        }
        return rpta;
    }
