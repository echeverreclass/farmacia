...
public class Caja {
    ...
    public Caja(int idcaja, String caFecha, String hora, double total_ingreso, double total_egreso, double saldo_final, String nroCaja, String caEstado, String uDni, String tienda) {
        this.idcaja = idcaja;
