...
public class CuentasBancariasProveedor_IU extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(txtRuc, javax.swing.GroupLayout.PREFERRED_SIZE, 236, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        jLabel8.setText("* Para eliminar, seleccione una cuenta de la lista y luego clic en el boton eliminar.");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtCuenta, javax.swing.GroupLayout.PREFERRED_SIZE, 264, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel4)
                            .addComponent(txtNroCuenta, javax.swing.GroupLayout.PREFERRED_SIZE, 264, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(2, 2, 2)
                                ...
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txtBanco, javax.swing.GroupLayout.DEFAULT_SIZE, 322, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        if (txtBanco.getText().length() > 0) {
            if (txtNroCuenta.getText().length() > 0) {
                if (txtCuenta.getText().length() > 0) {
                    ...
                    oDetalleCuentasBancarias.setBanco(txtBanco.getText().toUpperCase());
                    oDetalleCuentasBancarias.setNroCuenta(txtNroCuenta.getText().toUpperCase());
                    oDetalleCuentasBancarias.setCuenta(txtCuenta.getText().toUpperCase());
                    ...
                    if (rpta) {
                        ...
                        int cantLista = tabla_reporte_cuentas_bancarias.getRowCount();
            ...
            JOptionPane.showMessageDialog(this, "Ingrese el nombre del banco");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (aviso == 0) {
            DetalleCuentaBancariasBD oDetalleCuentaBancariasBD = new DetalleCuentaBancariasBD();
            boolean rpt = oDetalleCuentaBancariasBD.eliminarDetalleCuentasBancarias(idcuentas);
            if (rpt) {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (txtRuc.getText().length() > 0) {
            ...
            if (tabla_temporal_proveedor.getRowCount() > 0) {
                ...
                error("No se encnt al proveedor, tienes que registrarlo primero..");
                txtRuc.requestFocus();
                txtRuc.setText("");
                txtRazonSocial.setText("");
                tabla_temporal_detalle_cuenta = oCuentas.buscarDetallesCuentasBancarias(txtRuc.getText().trim());
    ...
    private void tabla_reporte_cuentas_bancariasMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_reporte_cuentas_bancariasMousePressed
        // TODO add your handling code here:
        int fila = tabla_reporte_cuentas_bancarias.getSelectedRow();
        idcuentas = Integer.parseInt(tabla_reporte_cuentas_bancarias.getValueAt(fila, 0).toString());
