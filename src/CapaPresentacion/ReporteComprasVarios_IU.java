...
public class ReporteComprasVarios_IU extends javax.swing.JInternalFrame {
        ...
        try {
            ...
            if (dcFechaFinal.getDate() != null) {
                if (dcFechaInicio.getDate() != null) {
                    ...
                    String ruta = "/CapaPresentacion/Reportes/Reporte_Compras_Fechas.jasper";

                    Map parametro = new HashMap();
                    parametro.clear();
                    parametro.put("fechaInicio", dcn.format(dcFechaInicio.getDate()));
                    parametro.put("fechaFinal", dcn.format(dcFechaFinal.getDate()));
            ...
            if (!cmbDocumento.getSelectedItem().equals("Seleccionar")) {
                if (dcFechaFinalDocumentos.getDate() != null) {
                    if (dcFechaInicioDocumento.getDate() != null) {
                        ...
                        Map parametro = new HashMap();
                        parametro.clear();
                        parametro.put("fechaInicio", dcn.format(dcFechaInicioDocumento.getDate()));
                        parametro.put("fechaFinal", dcn.format(dcFechaFinalDocumentos.getDate()));
                        ...
                        jvmostrar.setTitle("REPORTE DE COMPRAS POR DOCUMENTOS");
                        jvmostrar.setVisible(true);
                        jvmostrar.setExtendedState(6);
                        jvmostrar.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
                ...
                advertencia("Regresa a seleccionar el documento");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void btnImprimirComprasProveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirComprasProveedorActionPerformed
        ...
        try {
            ...
            if (!cmbProveedor.getSelectedItem().equals("Seleccionar")) {
                if (dcFechaFinalProveedor.getDate() != null) {
                    if (dcFechaInicioProveedor.getDate() != null) {
                        JasperReport reporte = null;
                        InputStream reportStream;
                        ...
                        Map parametro = new HashMap();
                        parametro.clear();
                        parametro.put("fechaInicio", dcn.format(dcFechaInicioProveedor.getDate()));
                        parametro.put("fechaFinal", dcn.format(dcFechaFinalProveedor.getDate()));
                ...
                advertencia("Regresa a seleccionar el proveedor");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
