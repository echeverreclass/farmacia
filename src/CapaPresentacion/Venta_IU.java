...
public class Venta_IU extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnBuscarCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/buscar_proveedor.png"))); // NOI18N
        ...
        btnRegistrarCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/status_online.png"))); // NOI18N
        ...
        btnBuscar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/keyboard.png"))); // NOI18N
        ...
        btnRegistrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/coins.png"))); // NOI18N
    ...
    private void registrarDetallePedidos(int idventa) {
        ...
        for (int i = 0; i < cantPedidos; i++) {
            ...
            boolean rpta = oDetalleBD.registrarDetalleVenta(oDetalle);
